...
create_location1='J:\\מחלקת השקעות\\היחידה הטכנולוגית\\חנן\\דרישת מידע בנקים שנתית\\' +(current_year)+ '\\בנק אגוד\\*.txt'
create_location2='J:\\מחלקת השקעות\\היחידה הטכנולוגית\\חנן\\דרישת מידע בנקים שנתית\\' +(current_year)+ '\\בנק יהב\\*.txt'
